...
import { MarketsHeaderBand } from "./markets-header-band";
import { MarketsSubNav } from "./markets-sub-nav";
import { TradesFeed } from "./trades-feed";

export function MarketsBrowseShell() {
  ...
  return (
    <div className="flex w-full min-w-0 flex-col pb-4">
      <div className="mb-3 flex min-w-0 flex-col gap-2 border-b border-border pb-3">
        <MarketsSubNav active="browse" />
        <MarketsHeaderBand
          category={category}
